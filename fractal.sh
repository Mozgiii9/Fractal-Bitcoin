...
rm -rf fractald-0.1.7-x86_64-linux-gnu.tar.gz
sleep 5

# Переход в директорию и копирование конфигурации
cd fractald-0.1.7-x86_64-linux-gnu || { echo "Не удалось перейти в директорию"; exit 1; }
...
cd /root/fractald-0.1.7-x86_64-linux-gnu/bin || { echo "Не удалось перейти в директорию bin"; exit 1; }
